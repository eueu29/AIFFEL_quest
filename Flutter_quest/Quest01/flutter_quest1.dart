...
/// 회고
/// 선웅님과 처음으로 퀘스트를 같이 진행했다. 다트 언어에 대해 아직 숙지를 완전히 하지 못했다고 느껴 자신이 없는 상태였는데, 모르는 부분은 여쭤보면 하나하나 다 친절히 알려주셔서 많이 배우는 퀘스트였다. 분, 초를 이쁘게 시각화해서 보는 작업도 두가지 버전이나 시도해봤는데 만족스럽게 나온것 같다 :)
/// 아직 다트 언어가 너무 낯설어서 추가학습이 절실하다는 것을 뼈저리게 깨달았다. 그래도 파이썬보다 간단하게 작성되는 부분들(ex. ${count %4 == 0? 15:5})도 있고, 비슷한 부분들도 있어서 비교하면서 배우는 재미가 있다. 